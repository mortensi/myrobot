...
def post_uptime_warning():
    ...
    if uptime>172800:
        print("Uptime: {} days {} hours {} minutes".format(days, hours, minutes))
    else:
        print(bcolors.FAIL + "Uptime: {} days {} hours {} minutes".format(days, hours, minutes) + bcolors.ENDC)
        print(bcolors.FAIL + "The Server has been running for less than 48 hours, recheck data later" + bcolors.ENDC)
